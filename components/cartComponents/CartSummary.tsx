...
export default function CartSummary() {
  ...
  const handleCheckout = () => {
    router.push("/checkout"); // Go to checkout page (we’ll compute there too)
  };

  return (
    <motion.div
      className="w-full py-6 md:p-8 flex flex-col gap-3"
    ...
    >
      ...
      >
        <motion.button
          ...
          className="md:w-full bg-orange-600 text-white rounded-[10px] py-2.5 text-sm md:text-base font-medium hover:bg-orange-700 shadow-sm hover:shadow-md transition-all duration-300"
        >
          Proceed to Checkout
        </motion.button>
      </motion.div>
